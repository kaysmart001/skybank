...
<head>
  ...
  <title>Online Banking National Bank</title>
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="../SkyBank/">National Bank</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.php" class="logo"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto " href="../SkyBank/#Hero">Home</a></li>
          <li><a class="nav-link scrollto " href="../SkyBank/#info">Net Banking</a></li>
          <li><a class="nav-link scrollto" href="../SkyBank/#services">Services</a></li>
  
          <li><a class="nav-link scrollto" href="../SkyBank/about.php">About</a></li>
          <li><a class="nav-link scrollto" href="../SkyBank/#contact">Contact</a></li>
          <li><a class="nav-link scrollto" href="../SkyBank/user/login.php">Login</a></li>
  ...
  <main id="main">
   ...
   <p>
   Just register yourself to website, have a unique username<br> and password and you are good to go with your online<br> banking journey.   
   </p>
     </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="Online Banking.php">Online Banking</a></li>
