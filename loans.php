...
<head>
  ...
  <title>Loans <?php echo $bank_name?></title>
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="../SkyBank/"><?php echo $bank_name?></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="../SkyBank/about.html">About</a></li>
